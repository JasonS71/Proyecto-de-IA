...
socketio = SocketIO(app, cors_allowed_origins="*")  # Habilitar CORS para SocketIO
...
def classify():
    ...
    if 'audio' in request.files:
        ...
        socketio.emit('status', {'message': 'Subiendo archivo'}, room=sid)
        ...
        socketio.emit('status', {'message': 'Separando voz'}, room=sid)
        ...
        socketio.emit('status', {'message': 'Transcribiendo letra'}, room=sid)
        ...
        socketio.emit('status', {'message': 'Completado'}, room=sid)
